...
<?php if ($create_task->FILEPATH->Visible) { // FILEPATH ?>
	<tr id="r_FILEPATH">
		<td><span id="elh_create_task_FILEPATH"><?php echo $create_task->FILEPATH->FldCaption() ?></span></td>
...
<?php echo $create_task->FILEPATH->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($create_task->FILENAME->Visible) { // FILENAME ?>
	<tr id="r_FILENAME">
		<td><span id="elh_create_task_FILENAME"><?php echo $create_task->FILENAME->FldCaption() ?></span></td>
...
<?php echo $create_task->FILENAME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
