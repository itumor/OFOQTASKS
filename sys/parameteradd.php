...
$parameter_add = NULL; // Initialize page object first

class cparameter_add extends cparameter {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("parameterlist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($parameter_add)) $parameter_add = new cparameter_add();

// Page init
$parameter_add->Page_Init();

// Page main
$parameter_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$parameter_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var parameter_add = new ew_Page("parameter_add");
parameter_add.PageID = "add"; // Page ID
var EW_PAGE_ID = parameter_add.PageID; // For backward compatibility

// Form object
var fparameteradd = new ew_Form("fparameteradd");

// Validate form
fparameteradd.Validate = function() {
...
fparameteradd.Form_CustomValidate = 
...
fparameteradd.ValidateRequired = true;
<?php } else { ?>
fparameteradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fparameteradd.Lists["x_script_id"] = {"LinkField":"x_script_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_script_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $parameter_add->ShowPageHeader(); ?>
<?php
$parameter_add->ShowMessage();
?>
<form name="fparameteradd" id="fparameteradd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_parameteradd" class="table table-bordered table-striped">
