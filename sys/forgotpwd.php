...
class cforgotpwd extends c_login {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["_login"])) $GLOBALS["_login"] = &$this;
...
<div class="ewForgotpwdContent">
	<div class="control-group">
		...
		<div class="controls"><input type="text" name="email" id="email" class="input-large" value="<?php ew_HtmlEncode($forgotpwd->Email) ?>" size="30" maxlength="255" placeholder="<?php echo $Language->Phrase("UserEmail") ?>"></div>
	</div>
	<div class="control-group">
		<div class="controls">
