...
$update_task_FILEPATH_blobview = NULL; // Initialize page object first

class cupdate_task_FILEPATH_blobview extends cupdate_task {
	...
	// Page object name
	var $PageObjName = 'update_task_FILEPATH_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('update_task', 'x_FILEPATH');
...
// Create page object
if (!isset($update_task_FILEPATH_blobview)) $update_task_FILEPATH_blobview = new cupdate_task_FILEPATH_blobview();

// Page init
$update_task_FILEPATH_blobview->Page_Init();

// Page main
$update_task_FILEPATH_blobview->Page_Main();
?>
<?php
$update_task_FILEPATH_blobview->Page_Terminate();
?>
