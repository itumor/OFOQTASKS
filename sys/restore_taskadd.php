...
$restore_task_add = NULL; // Initialize page object first

class crestore_task_add extends crestore_task {
	...
	// Page object name
	var $PageObjName = 'restore_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("restore_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($restore_task_add)) $restore_task_add = new crestore_task_add();

// Page init
$restore_task_add->Page_Init();

// Page main
$restore_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$restore_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var restore_task_add = new ew_Page("restore_task_add");
restore_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = restore_task_add.PageID; // For backward compatibility

// Form object
var frestore_taskadd = new ew_Form("frestore_taskadd");

// Validate form
frestore_taskadd.Validate = function() {
...
frestore_taskadd.Form_CustomValidate = 
...
frestore_taskadd.ValidateRequired = true;
<?php } else { ?>
frestore_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
frestore_taskadd.Lists["x_server_id_mysqladmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
frestore_taskadd.Lists["x_HOSTNAME"] = {"LinkField":"x_server_hostname","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $restore_task_add->ShowPageHeader(); ?>
<?php
$restore_task_add->ShowMessage();
?>
<form name="frestore_taskadd" id="frestore_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="restore_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_restore_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
frestore_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$restore_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$restore_task_add->Page_Terminate();
?>
