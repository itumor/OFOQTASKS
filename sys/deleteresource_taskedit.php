...
$deleteresource_task_edit = NULL; // Initialize page object first

class cdeleteresource_task_edit extends cdeleteresource_task {
	...
	// Page object name
	var $PageObjName = 'deleteresource_task_edit';
...
// Create page object
if (!isset($deleteresource_task_edit)) $deleteresource_task_edit = new cdeleteresource_task_edit();

// Page init
$deleteresource_task_edit->Page_Init();

// Page main
$deleteresource_task_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$deleteresource_task_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var deleteresource_task_edit = new ew_Page("deleteresource_task_edit");
deleteresource_task_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = deleteresource_task_edit.PageID; // For backward compatibility

// Form object
var fdeleteresource_taskedit = new ew_Form("fdeleteresource_taskedit");

// Validate form
fdeleteresource_taskedit.Validate = function() {
...
fdeleteresource_taskedit.Form_CustomValidate = 
...
fdeleteresource_taskedit.ValidateRequired = true;
<?php } else { ?>
fdeleteresource_taskedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdeleteresource_taskedit.Lists["x_server_id_glassfishadmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $deleteresource_task_edit->ShowPageHeader(); ?>
<?php
$deleteresource_task_edit->ShowMessage();
?>
<form name="ewPagerForm" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($deleteresource_task_edit->Pager)) $deleteresource_task_edit->Pager = new cNumericPager($deleteresource_task_edit->StartRec, $deleteresource_task_edit->DisplayRecs, $deleteresource_task_edit->TotalRecs, $deleteresource_task_edit->RecRange) ?>
<?php if ($deleteresource_task_edit->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($deleteresource_task_edit->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $deleteresource_task_edit->PageUrl() ?>start=<?php echo $deleteresource_task_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($deleteresource_task_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $deleteresource_task_edit->PageUrl() ?>start=<?php echo $deleteresource_task_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($deleteresource_task_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $deleteresource_task_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($deleteresource_task_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $deleteresource_task_edit->PageUrl() ?>start=<?php echo $deleteresource_task_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($deleteresource_task_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $deleteresource_task_edit->PageUrl() ?>start=<?php echo $deleteresource_task_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<form name="fdeleteresource_taskedit" id="fdeleteresource_taskedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="deleteresource_task">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_deleteresource_taskedit" class="table table-bordered table-striped">
...
<?php echo $deleteresource_task->id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($deleteresource_task->id->CurrentValue) ?>">
<?php echo $deleteresource_task->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fdeleteresource_taskedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$deleteresource_task_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$deleteresource_task_edit->Page_Terminate();
?>
