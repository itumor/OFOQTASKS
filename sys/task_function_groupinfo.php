...
$task_function_group = NULL;

//
// Table class for task_function_group
//
class ctask_function_group extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'task_function_group';
		$this->TableName = 'task_function_group';
		...
		$this->task_function_group_id = new cField('task_function_group', 'task_function_group', 'x_task_function_group_id', 'task_function_group_id', '`task_function_group_id`', '`task_function_group_id`', 3, -1, FALSE, '`task_function_group_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// task_id
		$this->task_id = new cField('task_function_group', 'task_function_group', 'x_task_id', 'task_id', '`task_id`', '`task_id`', 3, -1, FALSE, '`task_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->task_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['task_id'] = &$this->task_id;

		// function_group_id
		$this->function_group_id = new cField('task_function_group', 'task_function_group', 'x_function_group_id', 'function_group_id', '`function_group_id`', '`function_group_id`', 3, -1, FALSE, '`function_group_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`task_function_group`";
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('task_function_group_id', $rs))
				ew_AddFilter($where, ew_QuotedName('task_function_group_id') . '=' . ew_QuotedValue($rs['task_function_group_id'], $this->task_function_group_id->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function SqlKeyFilter() {
		return "`task_function_group_id` = @task_function_group_id@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->task_function_group_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@task_function_group_id@", ew_AdjustSql($this->task_function_group_id->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "task_function_grouplist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("task_function_groupview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("task_function_groupview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "task_function_groupadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("task_function_groupedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("task_function_groupadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("task_function_groupdelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->task_function_group_id->CurrentValue)) {
			$sUrl .= "task_function_group_id=" . urlencode($this->task_function_group_id->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["task_function_group_id"]; // task_function_group_id
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->task_function_group_id->CurrentValue = $key;
