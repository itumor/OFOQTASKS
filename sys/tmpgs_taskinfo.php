...
//
// Table class for tmpgs_task
//
class ctmpgs_task extends cTable {
	var $id;
	var $username;
	var $datetime;
	...
	function __construct() {
		...
		$this->TableVar = 'tmpgs_task';
		$this->TableName = 'tmpgs_task';
		...
		// id
		$this->id = new cField('tmpgs_task', 'tmpgs_task', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// username
		$this->username = new cField('tmpgs_task', 'tmpgs_task', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['username'] = &$this->username;

		// datetime
		$this->datetime = new cField('tmpgs_task', 'tmpgs_task', 'x_datetime', 'datetime', '`datetime`', 'DATE_FORMAT(`datetime`, \'%d/%m/%Y %H:%i:%s\')', 135, -1, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['datetime'] = &$this->datetime;

		// server_id_glassfishscript
		$this->server_id_glassfishscript = new cField('tmpgs_task', 'tmpgs_task', 'x_server_id_glassfishscript', 'server_id_glassfishscript', '`server_id_glassfishscript`', '`server_id_glassfishscript`', 200, -1, FALSE, '`server_id_glassfishscript`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['server_id_glassfishscript'] = &$this->server_id_glassfishscript;

		// glassfishfolder
		$this->glassfishfolder = new cField('tmpgs_task', 'tmpgs_task', 'x_glassfishfolder', 'glassfishfolder', '`glassfishfolder`', '`glassfishfolder`', 200, -1, FALSE, '`glassfishfolder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['glassfishfolder'] = &$this->glassfishfolder;

		// domainname
		$this->domainname = new cField('tmpgs_task', 'tmpgs_task', 'x_domainname', 'domainname', '`domainname`', '`domainname`', 200, -1, FALSE, '`domainname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tmpgs_taskview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tmpgs_taskview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "tmpgs_taskadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tmpgs_taskedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tmpgs_taskadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tmpgs_taskdelete.php", $this->UrlParm());
	}
