...
$editportalext_task = NULL;

//
// Table class for editportalext_task
//
class ceditportalext_task extends cTable {
	var $id;
	var $username;
	var $datetime;
	...
	function __construct() {
		...
		$this->TableVar = 'editportalext_task';
		$this->TableName = 'editportalext_task';
		...
		// id
		$this->id = new cField('editportalext_task', 'editportalext_task', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// username
		$this->username = new cField('editportalext_task', 'editportalext_task', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['username'] = &$this->username;

		// datetime
		$this->datetime = new cField('editportalext_task', 'editportalext_task', 'x_datetime', 'datetime', '`datetime`', 'DATE_FORMAT(`datetime`, \'%d/%m/%Y %H:%i:%s\')', 135, -1, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['datetime'] = &$this->datetime;

		// server_id_glassfishscript
		$this->server_id_glassfishscript = new cField('editportalext_task', 'editportalext_task', 'x_server_id_glassfishscript', 'server_id_glassfishscript', '`server_id_glassfishscript`', '`server_id_glassfishscript`', 200, -1, FALSE, '`server_id_glassfishscript`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['server_id_glassfishscript'] = &$this->server_id_glassfishscript;

		// glassfishfolder
		$this->glassfishfolder = new cField('editportalext_task', 'editportalext_task', 'x_glassfishfolder', 'glassfishfolder', '`glassfishfolder`', '`glassfishfolder`', 200, -1, FALSE, '`glassfishfolder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['glassfishfolder'] = &$this->glassfishfolder;

		// domainname
		$this->domainname = new cField('editportalext_task', 'editportalext_task', 'x_domainname', 'domainname', '`domainname`', '`domainname`', 200, -1, FALSE, '`domainname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['domainname'] = &$this->domainname;

		// liferaydbip
		$this->liferaydbip = new cField('editportalext_task', 'editportalext_task', 'x_liferaydbip', 'liferaydbip', '`liferaydbip`', '`liferaydbip`', 200, -1, FALSE, '`liferaydbip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['liferaydbip'] = &$this->liferaydbip;

		// liferaydbname
		$this->liferaydbname = new cField('editportalext_task', 'editportalext_task', 'x_liferaydbname', 'liferaydbname', '`liferaydbname`', '`liferaydbname`', 200, -1, FALSE, '`liferaydbname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['liferaydbname'] = &$this->liferaydbname;

		// liferaydbuser
		$this->liferaydbuser = new cField('editportalext_task', 'editportalext_task', 'x_liferaydbuser', 'liferaydbuser', '`liferaydbuser`', '`liferaydbuser`', 200, -1, FALSE, '`liferaydbuser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['liferaydbuser'] = &$this->liferaydbuser;

		// liferaydbpass
		$this->liferaydbpass = new cField('editportalext_task', 'editportalext_task', 'x_liferaydbpass', 'liferaydbpass', '`liferaydbpass`', '`liferaydbpass`', 200, -1, FALSE, '`liferaydbpass`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['liferaydbpass'] = &$this->liferaydbpass;
	}
	...
	// Update Table
	var $UpdateTable = "`editportalext_task`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "editportalext_tasklist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("editportalext_taskview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("editportalext_taskview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "editportalext_taskadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("editportalext_taskedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("editportalext_taskadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("editportalext_taskdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->liferaydbip->Exportable) $Doc->ExportCaption($this->liferaydbip);
				if ($this->liferaydbname->Exportable) $Doc->ExportCaption($this->liferaydbname);
				if ($this->liferaydbuser->Exportable) $Doc->ExportCaption($this->liferaydbuser);
				if ($this->liferaydbpass->Exportable) $Doc->ExportCaption($this->liferaydbpass);
			} else {
				if ($this->id->Exportable) $Doc->ExportCaption($this->id);
				if ($this->username->Exportable) $Doc->ExportCaption($this->username);
				if ($this->datetime->Exportable) $Doc->ExportCaption($this->datetime);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->liferaydbip->Exportable) $Doc->ExportField($this->liferaydbip);
					if ($this->liferaydbname->Exportable) $Doc->ExportField($this->liferaydbname);
					if ($this->liferaydbuser->Exportable) $Doc->ExportField($this->liferaydbuser);
					if ($this->liferaydbpass->Exportable) $Doc->ExportField($this->liferaydbpass);
				} else {
					if ($this->id->Exportable) $Doc->ExportField($this->id);
					if ($this->username->Exportable) $Doc->ExportField($this->username);
					if ($this->datetime->Exportable) $Doc->ExportField($this->datetime);
