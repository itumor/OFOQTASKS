...
$receive_task_add = NULL; // Initialize page object first

class creceive_task_add extends creceive_task {
	...
	// Page object name
	var $PageObjName = 'receive_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("receive_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($receive_task_add)) $receive_task_add = new creceive_task_add();

// Page init
$receive_task_add->Page_Init();

// Page main
$receive_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$receive_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var receive_task_add = new ew_Page("receive_task_add");
receive_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = receive_task_add.PageID; // For backward compatibility

// Form object
var freceive_taskadd = new ew_Form("freceive_taskadd");

// Validate form
freceive_taskadd.Validate = function() {
...
freceive_taskadd.Form_CustomValidate = 
...
freceive_taskadd.ValidateRequired = true;
<?php } else { ?>
freceive_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
freceive_taskadd.Lists["x_server_id_sendreceive"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $receive_task_add->ShowPageHeader(); ?>
<?php
$receive_task_add->ShowMessage();
?>
<form name="freceive_taskadd" id="freceive_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="receive_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_receive_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
freceive_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$receive_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$receive_task_add->Page_Terminate();
?>
