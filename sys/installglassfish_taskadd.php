...
$installglassfish_task_add = NULL; // Initialize page object first

class cinstallglassfish_task_add extends cinstallglassfish_task {
	...
	// Page object name
	var $PageObjName = 'installglassfish_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("installglassfish_tasklist.php"); // No matching record, return to list
				}
				break;
	...
	function LoadDefaultValues() {
		...
		$this->adminpassword->CurrentValue = NULL;
		$this->adminpassword->OldValue = $this->adminpassword->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// adminpassword
		$this->adminpassword->SetDbValueDef($rsnew, $this->adminpassword->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($installglassfish_task_add)) $installglassfish_task_add = new cinstallglassfish_task_add();

// Page init
$installglassfish_task_add->Page_Init();

// Page main
$installglassfish_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$installglassfish_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var installglassfish_task_add = new ew_Page("installglassfish_task_add");
installglassfish_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = installglassfish_task_add.PageID; // For backward compatibility

// Form object
var finstallglassfish_taskadd = new ew_Form("finstallglassfish_taskadd");

// Validate form
finstallglassfish_taskadd.Validate = function() {
...
finstallglassfish_taskadd.Form_CustomValidate = 
...
finstallglassfish_taskadd.ValidateRequired = true;
<?php } else { ?>
finstallglassfish_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
finstallglassfish_taskadd.Lists["x_server_id_glassfishscript"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $installglassfish_task_add->ShowPageHeader(); ?>
<?php
$installglassfish_task_add->ShowMessage();
?>
<form name="finstallglassfish_taskadd" id="finstallglassfish_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="installglassfish_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_installglassfish_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
finstallglassfish_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$installglassfish_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$installglassfish_task_add->Page_Terminate();
?>
