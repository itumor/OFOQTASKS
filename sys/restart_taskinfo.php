...
class crestart_task extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'restart_task';
		$this->TableName = 'restart_task';
		...
		// id
		$this->id = new cField('restart_task', 'restart_task', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("restart_taskview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("restart_taskview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "restart_taskadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("restart_taskedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("restart_taskadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("restart_taskdelete.php", $this->UrlParm());
	}
