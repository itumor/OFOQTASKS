...
$function_group_relation = NULL;

//
// Table class for function_group_relation
//
class cfunction_group_relation extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'function_group_relation';
		$this->TableName = 'function_group_relation';
		...
		$this->function_group_relation_id = new cField('function_group_relation', 'function_group_relation', 'x_function_group_relation_id', 'function_group_relation_id', '`function_group_relation_id`', '`function_group_relation_id`', 3, -1, FALSE, '`function_group_relation_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// function_group_id
		$this->function_group_id = new cField('function_group_relation', 'function_group_relation', 'x_function_group_id', 'function_group_id', '`function_group_id`', '`function_group_id`', 3, -1, FALSE, '`function_group_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// script_function_id
		$this->script_function_id = new cField('function_group_relation', 'function_group_relation', 'x_script_function_id', 'script_function_id', '`script_function_id`', '`script_function_id`', 3, -1, FALSE, '`script_function_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// priority
		$this->priority = new cField('function_group_relation', 'function_group_relation', 'x_priority', 'priority', '`priority`', '`priority`', 3, -1, FALSE, '`priority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "`function_group_relation`";
	}
	...
	// Update Table
	var $UpdateTable = "`function_group_relation`";
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('function_group_relation_id', $rs))
				ew_AddFilter($where, ew_QuotedName('function_group_relation_id') . '=' . ew_QuotedValue($rs['function_group_relation_id'], $this->function_group_relation_id->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function SqlKeyFilter() {
		return "`function_group_relation_id` = @function_group_relation_id@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->function_group_relation_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@function_group_relation_id@", ew_AdjustSql($this->function_group_relation_id->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "function_group_relationlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("function_group_relationview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("function_group_relationview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "function_group_relationadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("function_group_relationedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("function_group_relationadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("function_group_relationdelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->function_group_relation_id->CurrentValue)) {
			$sUrl .= "function_group_relation_id=" . urlencode($this->function_group_relation_id->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["function_group_relation_id"]; // function_group_relation_id
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->function_group_relation_id->CurrentValue = $key;
