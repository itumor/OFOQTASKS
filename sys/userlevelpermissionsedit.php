...
<table class="ewPager">
<tr><td>
<?php if (!isset($userlevelpermissions_edit->Pager)) $userlevelpermissions_edit->Pager = new cNumericPager($userlevelpermissions_edit->StartRec, $userlevelpermissions_edit->DisplayRecs, $userlevelpermissions_edit->TotalRecs, $userlevelpermissions_edit->RecRange) ?>
<?php if ($userlevelpermissions_edit->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($userlevelpermissions_edit->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $userlevelpermissions_edit->PageUrl() ?>start=<?php echo $userlevelpermissions_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($userlevelpermissions_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $userlevelpermissions_edit->PageUrl() ?>start=<?php echo $userlevelpermissions_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($userlevelpermissions_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $userlevelpermissions_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($userlevelpermissions_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $userlevelpermissions_edit->PageUrl() ?>start=<?php echo $userlevelpermissions_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($userlevelpermissions_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $userlevelpermissions_edit->PageUrl() ?>start=<?php echo $userlevelpermissions_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
