...
$glassfishtuning_task_edit = NULL; // Initialize page object first

class cglassfishtuning_task_edit extends cglassfishtuning_task {
	...
	// Page object name
	var $PageObjName = 'glassfishtuning_task_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// JVMHEAPSIZE
			$this->JVMHEAPSIZE->SetDbValueDef($rsnew, $this->JVMHEAPSIZE->CurrentValue, "", $this->JVMHEAPSIZE->ReadOnly);

			// JVMHEAPSIZEXMN
			$this->JVMHEAPSIZEXMN->SetDbValueDef($rsnew, $this->JVMHEAPSIZEXMN->CurrentValue, "", $this->JVMHEAPSIZEXMN->ReadOnly);

			// JVMPARALLELGCTHREADS
			$this->JVMPARALLELGCTHREADS->SetDbValueDef($rsnew, $this->JVMPARALLELGCTHREADS->CurrentValue, "", $this->JVMPARALLELGCTHREADS->ReadOnly);

			// MAXTHREADPOOLSIZE
			$this->MAXTHREADPOOLSIZE->SetDbValueDef($rsnew, $this->MAXTHREADPOOLSIZE->CurrentValue, "", $this->MAXTHREADPOOLSIZE->ReadOnly);

			// LargePageSizeInBytes
			$this->LargePageSizeInBytes->SetDbValueDef($rsnew, $this->LargePageSizeInBytes->CurrentValue, "", $this->LargePageSizeInBytes->ReadOnly);
...
// Create page object
if (!isset($glassfishtuning_task_edit)) $glassfishtuning_task_edit = new cglassfishtuning_task_edit();

// Page init
$glassfishtuning_task_edit->Page_Init();

// Page main
$glassfishtuning_task_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$glassfishtuning_task_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var glassfishtuning_task_edit = new ew_Page("glassfishtuning_task_edit");
glassfishtuning_task_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = glassfishtuning_task_edit.PageID; // For backward compatibility

// Form object
var fglassfishtuning_taskedit = new ew_Form("fglassfishtuning_taskedit");

// Validate form
fglassfishtuning_taskedit.Validate = function() {
...
fglassfishtuning_taskedit.Form_CustomValidate = 
...
fglassfishtuning_taskedit.ValidateRequired = true;
<?php } else { ?>
fglassfishtuning_taskedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fglassfishtuning_taskedit.Lists["x_server_id_glassfishscript"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $glassfishtuning_task_edit->ShowPageHeader(); ?>
<?php
$glassfishtuning_task_edit->ShowMessage();
?>
<form name="ewPagerForm" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($glassfishtuning_task_edit->Pager)) $glassfishtuning_task_edit->Pager = new cNumericPager($glassfishtuning_task_edit->StartRec, $glassfishtuning_task_edit->DisplayRecs, $glassfishtuning_task_edit->TotalRecs, $glassfishtuning_task_edit->RecRange) ?>
<?php if ($glassfishtuning_task_edit->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($glassfishtuning_task_edit->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $glassfishtuning_task_edit->PageUrl() ?>start=<?php echo $glassfishtuning_task_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($glassfishtuning_task_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $glassfishtuning_task_edit->PageUrl() ?>start=<?php echo $glassfishtuning_task_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($glassfishtuning_task_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $glassfishtuning_task_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($glassfishtuning_task_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $glassfishtuning_task_edit->PageUrl() ?>start=<?php echo $glassfishtuning_task_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($glassfishtuning_task_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $glassfishtuning_task_edit->PageUrl() ?>start=<?php echo $glassfishtuning_task_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<form name="fglassfishtuning_taskedit" id="fglassfishtuning_taskedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="glassfishtuning_task">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_glassfishtuning_taskedit" class="table table-bordered table-striped">
...
<?php echo $glassfishtuning_task->id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($glassfishtuning_task->id->CurrentValue) ?>">
<?php echo $glassfishtuning_task->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fglassfishtuning_taskedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$glassfishtuning_task_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$glassfishtuning_task_edit->Page_Terminate();
?>
