...
$addpool_task_add = NULL; // Initialize page object first

class caddpool_task_add extends caddpool_task {
	...
	// Page object name
	var $PageObjName = 'addpool_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("addpool_tasklist.php"); // No matching record, return to list
				}
				break;
	...
	function LoadDefaultValues() {
		...
		$this->DBS_JDBC->CurrentValue = NULL;
		$this->DBS_JDBC->OldValue = $this->DBS_JDBC->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// DBS_JDBC
		$this->DBS_JDBC->SetDbValueDef($rsnew, $this->DBS_JDBC->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($addpool_task_add)) $addpool_task_add = new caddpool_task_add();

// Page init
$addpool_task_add->Page_Init();

// Page main
$addpool_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$addpool_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var addpool_task_add = new ew_Page("addpool_task_add");
addpool_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = addpool_task_add.PageID; // For backward compatibility

// Form object
var faddpool_taskadd = new ew_Form("faddpool_taskadd");

// Validate form
faddpool_taskadd.Validate = function() {
...
faddpool_taskadd.Form_CustomValidate = 
...
faddpool_taskadd.ValidateRequired = true;
<?php } else { ?>
faddpool_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faddpool_taskadd.Lists["x_server_id_glassfishadmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $addpool_task_add->ShowPageHeader(); ?>
<?php
$addpool_task_add->ShowMessage();
?>
<form name="faddpool_taskadd" id="faddpool_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="addpool_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_addpool_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
faddpool_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$addpool_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$addpool_task_add->Page_Terminate();
?>
