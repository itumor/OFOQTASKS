...
<?php if ($drop_task->FILEPATH->Visible) { // FILEPATH ?>
		<td><span id="elh_drop_task_FILEPATH" class="drop_task_FILEPATH"><?php echo $drop_task->FILEPATH->FldCaption() ?></span></td>
<?php } ?>
<?php if ($drop_task->FILENAME->Visible) { // FILENAME ?>
		<td><span id="elh_drop_task_FILENAME" class="drop_task_FILENAME"><?php echo $drop_task->FILENAME->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $drop_task_delete->RowCnt ?>_drop_task_FILEPATH" class="control-group drop_task_FILEPATH">
...
<span id="el<?php echo $drop_task_delete->RowCnt ?>_drop_task_FILENAME" class="control-group drop_task_FILENAME">
