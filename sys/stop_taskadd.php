...
$stop_task_add = NULL; // Initialize page object first

class cstop_task_add extends cstop_task {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("stop_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($stop_task_add)) $stop_task_add = new cstop_task_add();

// Page init
$stop_task_add->Page_Init();

// Page main
$stop_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$stop_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var stop_task_add = new ew_Page("stop_task_add");
stop_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = stop_task_add.PageID; // For backward compatibility

// Form object
var fstop_taskadd = new ew_Form("fstop_taskadd");

// Validate form
fstop_taskadd.Validate = function() {
...
fstop_taskadd.Form_CustomValidate = 
...
fstop_taskadd.ValidateRequired = true;
<?php } else { ?>
fstop_taskadd.ValidateRequired = false; 
<?php } ?>
...
<?php $stop_task_add->ShowPageHeader(); ?>
<?php
$stop_task_add->ShowMessage();
?>
<form name="fstop_taskadd" id="fstop_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="stop_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_stop_taskadd" class="table table-bordered table-striped">
