...
$task_function_group_add = NULL; // Initialize page object first

class ctask_function_group_add extends ctask_function_group {
	...
	// Page object name
	var $PageObjName = 'task_function_group_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["task_function_group_id"] != "") {
				...
				$this->setKey("task_function_group_id", $this->task_function_group_id->CurrentValue); // Set up key
			} else {
				$this->setKey("task_function_group_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("task_function_grouplist.php"); // No matching record, return to list
				}
				break;
	...
	function AddRow($rsold = NULL) {
		...
		if ($AddRow) {
			$this->task_function_group_id->setDbValue($conn->Insert_ID());
			$rsnew['task_function_group_id'] = $this->task_function_group_id->DbValue;
		}
		if ($AddRow) {
...
// Create page object
if (!isset($task_function_group_add)) $task_function_group_add = new ctask_function_group_add();

// Page init
$task_function_group_add->Page_Init();

// Page main
$task_function_group_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$task_function_group_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var task_function_group_add = new ew_Page("task_function_group_add");
task_function_group_add.PageID = "add"; // Page ID
var EW_PAGE_ID = task_function_group_add.PageID; // For backward compatibility

// Form object
var ftask_function_groupadd = new ew_Form("ftask_function_groupadd");

// Validate form
ftask_function_groupadd.Validate = function() {
...
ftask_function_groupadd.Form_CustomValidate = 
...
ftask_function_groupadd.ValidateRequired = true;
<?php } else { ?>
ftask_function_groupadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftask_function_groupadd.Lists["x_task_id"] = {"LinkField":"x_task_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_task_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftask_function_groupadd.Lists["x_function_group_id"] = {"LinkField":"x_function_group_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_function_group_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $task_function_group_add->ShowPageHeader(); ?>
<?php
$task_function_group_add->ShowMessage();
?>
<form name="ftask_function_groupadd" id="ftask_function_groupadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_task_function_groupadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
ftask_function_groupadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$task_function_group_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$task_function_group_add->Page_Terminate();
?>
