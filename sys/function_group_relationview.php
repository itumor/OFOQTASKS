...
$function_group_relation_view = NULL; // Initialize page object first

class cfunction_group_relation_view extends cfunction_group_relation {
	...
	// Page object name
	var $PageObjName = 'function_group_relation_view';
	...
	function __construct() {
		...
		if (@$_GET["function_group_relation_id"] <> "") {
			$this->RecKey["function_group_relation_id"] = $_GET["function_group_relation_id"];
			$KeyUrl .= "&function_group_relation_id=" . urlencode($this->RecKey["function_group_relation_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["function_group_relation_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["function_group_relation_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "function_group_relationlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "function_group_relationlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($function_group_relation_view)) $function_group_relation_view = new cfunction_group_relation_view();

// Page init
$function_group_relation_view->Page_Init();

// Page main
$function_group_relation_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$function_group_relation_view->Page_Render();
?>
...
// Page object
var function_group_relation_view = new ew_Page("function_group_relation_view");
function_group_relation_view.PageID = "view"; // Page ID
var EW_PAGE_ID = function_group_relation_view.PageID; // For backward compatibility

// Form object
var ffunction_group_relationview = new ew_Form("ffunction_group_relationview");

// Form_CustomValidate event
ffunction_group_relationview.Form_CustomValidate = 
...
ffunction_group_relationview.ValidateRequired = true;
<?php } else { ?>
ffunction_group_relationview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ffunction_group_relationview.Lists["x_function_group_id"] = {"LinkField":"x_function_group_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_function_group_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ffunction_group_relationview.Lists["x_script_function_id"] = {"LinkField":"x_script_function_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_script_function_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $function_group_relation_view->ExportOptions->Render("body") ?>
<?php if (!$function_group_relation_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($function_group_relation_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $function_group_relation_view->ShowPageHeader(); ?>
<?php
$function_group_relation_view->ShowMessage();
?>
<?php if ($function_group_relation->Export == "") { ?>
<form name="ewPagerForm" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($function_group_relation_view->Pager)) $function_group_relation_view->Pager = new cNumericPager($function_group_relation_view->StartRec, $function_group_relation_view->DisplayRecs, $function_group_relation_view->TotalRecs, $function_group_relation_view->RecRange) ?>
<?php if ($function_group_relation_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($function_group_relation_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $function_group_relation_view->PageUrl() ?>start=<?php echo $function_group_relation_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($function_group_relation_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $function_group_relation_view->PageUrl() ?>start=<?php echo $function_group_relation_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($function_group_relation_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $function_group_relation_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($function_group_relation_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $function_group_relation_view->PageUrl() ?>start=<?php echo $function_group_relation_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($function_group_relation_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $function_group_relation_view->PageUrl() ?>start=<?php echo $function_group_relation_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<?php } ?>
<form name="ffunction_group_relationview" id="ffunction_group_relationview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="function_group_relation">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_function_group_relationview" class="table table-bordered table-striped">
...
<script type="text/javascript">
ffunction_group_relationview.Init();
</script>
<?php
$function_group_relation_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($function_group_relation->Export == "") { ?>
...
<?php
$function_group_relation_view->Page_Terminate();
?>
