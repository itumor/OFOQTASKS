...
$deletepool_task_add = NULL; // Initialize page object first

class cdeletepool_task_add extends cdeletepool_task {
	...
	// Page object name
	var $PageObjName = 'deletepool_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("deletepool_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($deletepool_task_add)) $deletepool_task_add = new cdeletepool_task_add();

// Page init
$deletepool_task_add->Page_Init();

// Page main
$deletepool_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$deletepool_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var deletepool_task_add = new ew_Page("deletepool_task_add");
deletepool_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = deletepool_task_add.PageID; // For backward compatibility

// Form object
var fdeletepool_taskadd = new ew_Form("fdeletepool_taskadd");

// Validate form
fdeletepool_taskadd.Validate = function() {
...
fdeletepool_taskadd.Form_CustomValidate = 
...
fdeletepool_taskadd.ValidateRequired = true;
<?php } else { ?>
fdeletepool_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdeletepool_taskadd.Lists["x_server_id_glassfishadmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $deletepool_task_add->ShowPageHeader(); ?>
<?php
$deletepool_task_add->ShowMessage();
?>
<form name="fdeletepool_taskadd" id="fdeletepool_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="deletepool_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_deletepool_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fdeletepool_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$deletepool_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$deletepool_task_add->Page_Terminate();
?>
