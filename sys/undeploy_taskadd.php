...
$undeploy_task_add = NULL; // Initialize page object first

class cundeploy_task_add extends cundeploy_task {
	...
	// Page object name
	var $PageObjName = 'undeploy_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("undeploy_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($undeploy_task_add)) $undeploy_task_add = new cundeploy_task_add();

// Page init
$undeploy_task_add->Page_Init();

// Page main
$undeploy_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$undeploy_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var undeploy_task_add = new ew_Page("undeploy_task_add");
undeploy_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = undeploy_task_add.PageID; // For backward compatibility

// Form object
var fundeploy_taskadd = new ew_Form("fundeploy_taskadd");

// Validate form
fundeploy_taskadd.Validate = function() {
...
fundeploy_taskadd.Form_CustomValidate = 
...
fundeploy_taskadd.ValidateRequired = true;
<?php } else { ?>
fundeploy_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fundeploy_taskadd.Lists["x_server_id_asadmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $undeploy_task_add->ShowPageHeader(); ?>
<?php
$undeploy_task_add->ShowMessage();
?>
<form name="fundeploy_taskadd" id="fundeploy_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="undeploy_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_undeploy_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fundeploy_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$undeploy_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$undeploy_task_add->Page_Terminate();
?>
