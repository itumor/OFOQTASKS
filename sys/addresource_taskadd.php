...
$addresource_task_add = NULL; // Initialize page object first

class caddresource_task_add extends caddresource_task {
	...
	// Page object name
	var $PageObjName = 'addresource_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("addresource_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($addresource_task_add)) $addresource_task_add = new caddresource_task_add();

// Page init
$addresource_task_add->Page_Init();

// Page main
$addresource_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$addresource_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var addresource_task_add = new ew_Page("addresource_task_add");
addresource_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = addresource_task_add.PageID; // For backward compatibility

// Form object
var faddresource_taskadd = new ew_Form("faddresource_taskadd");

// Validate form
faddresource_taskadd.Validate = function() {
...
faddresource_taskadd.Form_CustomValidate = 
...
faddresource_taskadd.ValidateRequired = true;
<?php } else { ?>
faddresource_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faddresource_taskadd.Lists["x_server_id_glassfishadmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $addresource_task_add->ShowPageHeader(); ?>
<?php
$addresource_task_add->ShowMessage();
?>
<form name="faddresource_taskadd" id="faddresource_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="addresource_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_addresource_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
faddresource_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$addresource_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$addresource_task_add->Page_Terminate();
?>
