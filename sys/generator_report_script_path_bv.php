...
$generator_report_script_path_blobview = NULL; // Initialize page object first

class cgenerator_report_script_path_blobview extends cgenerator_report {
	...
	// Page object name
	var $PageObjName = 'generator_report_script_path_blobview';
...
// Create page object
if (!isset($generator_report_script_path_blobview)) $generator_report_script_path_blobview = new cgenerator_report_script_path_blobview();

// Page init
$generator_report_script_path_blobview->Page_Init();

// Page main
$generator_report_script_path_blobview->Page_Main();
?>
<?php
$generator_report_script_path_blobview->Page_Terminate();
?>
