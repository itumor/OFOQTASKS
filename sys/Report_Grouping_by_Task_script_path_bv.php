...
$Report_Grouping_by_Task_script_path_blobview = NULL; // Initialize page object first

class cReport_Grouping_by_Task_script_path_blobview extends cgenerator_report {
	...
	// Page object name
	var $PageObjName = 'Report_Grouping_by_Task_script_path_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'generator report');
...
// Create page object
if (!isset($Report_Grouping_by_Task_script_path_blobview)) $Report_Grouping_by_Task_script_path_blobview = new cReport_Grouping_by_Task_script_path_blobview();

// Page init
$Report_Grouping_by_Task_script_path_blobview->Page_Init();

// Page main
$Report_Grouping_by_Task_script_path_blobview->Page_Main();
?>
<?php
$Report_Grouping_by_Task_script_path_blobview->Page_Terminate();
?>
