...
$listandstart_task = NULL;

//
// Table class for listandstart_task
//
class clistandstart_task extends cTable {
	var $id;
	...
	function __construct() {
		...
		$this->TableVar = 'listandstart_task';
		$this->TableName = 'listandstart_task';
		...
		// id
		$this->id = new cField('listandstart_task', 'listandstart_task', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// server_id_mysqladmin
		$this->server_id_mysqladmin = new cField('listandstart_task', 'listandstart_task', 'x_server_id_mysqladmin', 'server_id_mysqladmin', '`server_id_mysqladmin`', '`server_id_mysqladmin`', 200, -1, FALSE, '`server_id_mysqladmin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`listandstart_task`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "listandstart_tasklist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("listandstart_taskview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("listandstart_taskview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "listandstart_taskadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("listandstart_taskedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("listandstart_taskadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("listandstart_taskdelete.php", $this->UrlParm());
	}
