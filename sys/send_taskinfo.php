...
//
// Table class for send_task
//
class csend_task extends cTable {
	var $id;
	var $username;
	var $datetime;
	...
	function __construct() {
		...
		$this->TableVar = 'send_task';
		$this->TableName = 'send_task';
		...
		// id
		$this->id = new cField('send_task', 'send_task', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// username
		$this->username = new cField('send_task', 'send_task', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['username'] = &$this->username;

		// datetime
		$this->datetime = new cField('send_task', 'send_task', 'x_datetime', 'datetime', '`datetime`', 'DATE_FORMAT(`datetime`, \'%d/%m/%Y %H:%i:%s\')', 135, -1, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['datetime'] = &$this->datetime;

		// server_id_sendreceive
		$this->server_id_sendreceive = new cField('send_task', 'send_task', 'x_server_id_sendreceive', 'server_id_sendreceive', '`server_id_sendreceive`', '`server_id_sendreceive`', 200, -1, FALSE, '`server_id_sendreceive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['server_id_sendreceive'] = &$this->server_id_sendreceive;

		// TARGET_FILENAME
		$this->TARGET_FILENAME = new cField('send_task', 'send_task', 'x_TARGET_FILENAME', 'TARGET_FILENAME', '`TARGET_FILENAME`', '`TARGET_FILENAME`', 200, -1, FALSE, '`TARGET_FILENAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TARGET_FILENAME'] = &$this->TARGET_FILENAME;

		// LOCAL_PATH
		$this->LOCAL_PATH = new cField('send_task', 'send_task', 'x_LOCAL_PATH', 'LOCAL_PATH', '`LOCAL_PATH`', '`LOCAL_PATH`', 200, -1, FALSE, '`LOCAL_PATH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['LOCAL_PATH'] = &$this->LOCAL_PATH;

		// REMOTE_IPAND1STLVL
		$this->REMOTE_IPAND1STLVL = new cField('send_task', 'send_task', 'x_REMOTE_IPAND1STLVL', 'REMOTE_IPAND1STLVL', '`REMOTE_IPAND1STLVL`', '`REMOTE_IPAND1STLVL`', 200, -1, FALSE, '`REMOTE_IPAND1STLVL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['REMOTE_IPAND1STLVL'] = &$this->REMOTE_IPAND1STLVL;

		// REMOTE_REMAIN_PATH
		$this->REMOTE_REMAIN_PATH = new cField('send_task', 'send_task', 'x_REMOTE_REMAIN_PATH', 'REMOTE_REMAIN_PATH', '`REMOTE_REMAIN_PATH`', '`REMOTE_REMAIN_PATH`', 200, -1, FALSE, '`REMOTE_REMAIN_PATH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['REMOTE_REMAIN_PATH'] = &$this->REMOTE_REMAIN_PATH;

		// REMOTE_USERNAME
		$this->REMOTE_USERNAME = new cField('send_task', 'send_task', 'x_REMOTE_USERNAME', 'REMOTE_USERNAME', '`REMOTE_USERNAME`', '`REMOTE_USERNAME`', 200, -1, FALSE, '`REMOTE_USERNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['REMOTE_USERNAME'] = &$this->REMOTE_USERNAME;

		// REMOTE_PASSWORD
		$this->REMOTE_PASSWORD = new cField('send_task', 'send_task', 'x_REMOTE_PASSWORD', 'REMOTE_PASSWORD', '`REMOTE_PASSWORD`', '`REMOTE_PASSWORD`', 200, -1, FALSE, '`REMOTE_PASSWORD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['REMOTE_PASSWORD'] = &$this->REMOTE_PASSWORD;

		// REMOTE_DOMAIN
		$this->REMOTE_DOMAIN = new cField('send_task', 'send_task', 'x_REMOTE_DOMAIN', 'REMOTE_DOMAIN', '`REMOTE_DOMAIN`', '`REMOTE_DOMAIN`', 200, -1, FALSE, '`REMOTE_DOMAIN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("send_taskview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("send_taskview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "send_taskadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("send_taskedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("send_taskadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("send_taskdelete.php", $this->UrlParm());
	}
