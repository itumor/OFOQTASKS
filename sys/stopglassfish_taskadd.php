...
$stopglassfish_task_add = NULL; // Initialize page object first

class cstopglassfish_task_add extends cstopglassfish_task {
	...
	// Page object name
	var $PageObjName = 'stopglassfish_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("stopglassfish_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($stopglassfish_task_add)) $stopglassfish_task_add = new cstopglassfish_task_add();

// Page init
$stopglassfish_task_add->Page_Init();

// Page main
$stopglassfish_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$stopglassfish_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var stopglassfish_task_add = new ew_Page("stopglassfish_task_add");
stopglassfish_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = stopglassfish_task_add.PageID; // For backward compatibility

// Form object
var fstopglassfish_taskadd = new ew_Form("fstopglassfish_taskadd");

// Validate form
fstopglassfish_taskadd.Validate = function() {
...
fstopglassfish_taskadd.Form_CustomValidate = 
...
fstopglassfish_taskadd.ValidateRequired = true;
<?php } else { ?>
fstopglassfish_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fstopglassfish_taskadd.Lists["x_server_id_asadmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $stopglassfish_task_add->ShowPageHeader(); ?>
<?php
$stopglassfish_task_add->ShowMessage();
?>
<form name="fstopglassfish_taskadd" id="fstopglassfish_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="stopglassfish_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_stopglassfish_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fstopglassfish_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$stopglassfish_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$stopglassfish_task_add->Page_Terminate();
?>
