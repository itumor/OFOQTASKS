...
$Geport_Report_Grouping_by_Task_script_path_blobview = NULL; // Initialize page object first

class cGeport_Report_Grouping_by_Task_script_path_blobview extends cgenerator_report {
	...
	// Page object name
	var $PageObjName = 'Geport_Report_Grouping_by_Task_script_path_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('generator_report', 'x_script_path');
...
// Create page object
if (!isset($Geport_Report_Grouping_by_Task_script_path_blobview)) $Geport_Report_Grouping_by_Task_script_path_blobview = new cGeport_Report_Grouping_by_Task_script_path_blobview();

// Page init
$Geport_Report_Grouping_by_Task_script_path_blobview->Page_Init();

// Page main
$Geport_Report_Grouping_by_Task_script_path_blobview->Page_Main();
?>
<?php
$Geport_Report_Grouping_by_Task_script_path_blobview->Page_Terminate();
?>
