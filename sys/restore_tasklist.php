...
frestore_tasklist.Lists["x_server_id_mysqladmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
frestore_tasklist.Lists["x_HOSTNAME"] = {"LinkField":"x_server_hostname","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($restore_task->server_id_mysqladmin->Visible) { // server_id_mysqladmin ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $restore_task->SortUrl($restore_task->server_id_mysqladmin) ?>',1);"><div id="elh_restore_task_server_id_mysqladmin" class="restore_task_server_id_mysqladmin">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $restore_task->server_id_mysqladmin->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($restore_task->server_id_mysqladmin->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($restore_task->server_id_mysqladmin->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($restore_task->HOSTNAME->Visible) { // HOSTNAME ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $restore_task->SortUrl($restore_task->HOSTNAME) ?>',1);"><div id="elh_restore_task_HOSTNAME" class="restore_task_HOSTNAME">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $restore_task->HOSTNAME->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($restore_task->HOSTNAME->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($restore_task->HOSTNAME->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
