...
$update_task_FILENAME_blobview = NULL; // Initialize page object first

class cupdate_task_FILENAME_blobview extends cupdate_task {
	...
	// Page object name
	var $PageObjName = 'update_task_FILENAME_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'update_task');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('update_task', 'x_FILENAME');
...
// Create page object
if (!isset($update_task_FILENAME_blobview)) $update_task_FILENAME_blobview = new cupdate_task_FILENAME_blobview();

// Page init
$update_task_FILENAME_blobview->Page_Init();

// Page main
$update_task_FILENAME_blobview->Page_Main();
?>
<?php
$update_task_FILENAME_blobview->Page_Terminate();
?>
