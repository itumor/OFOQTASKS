...
$start_glassfish_task_add = NULL; // Initialize page object first

class cstart_glassfish_task_add extends cstart_glassfish_task {
	...
	// Page object name
	var $PageObjName = 'start_glassfish_task_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("start_glassfish_tasklist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($start_glassfish_task_add)) $start_glassfish_task_add = new cstart_glassfish_task_add();

// Page init
$start_glassfish_task_add->Page_Init();

// Page main
$start_glassfish_task_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$start_glassfish_task_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var start_glassfish_task_add = new ew_Page("start_glassfish_task_add");
start_glassfish_task_add.PageID = "add"; // Page ID
var EW_PAGE_ID = start_glassfish_task_add.PageID; // For backward compatibility

// Form object
var fstart_glassfish_taskadd = new ew_Form("fstart_glassfish_taskadd");

// Validate form
fstart_glassfish_taskadd.Validate = function() {
...
fstart_glassfish_taskadd.Form_CustomValidate = 
...
fstart_glassfish_taskadd.ValidateRequired = true;
<?php } else { ?>
fstart_glassfish_taskadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fstart_glassfish_taskadd.Lists["x_server_id_mysqladmin"] = {"LinkField":"x_server_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_server_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $start_glassfish_task_add->ShowPageHeader(); ?>
<?php
$start_glassfish_task_add->ShowMessage();
?>
<form name="fstart_glassfish_taskadd" id="fstart_glassfish_taskadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="start_glassfish_task">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_start_glassfish_taskadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fstart_glassfish_taskadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$start_glassfish_task_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$start_glassfish_task_add->Page_Terminate();
?>
