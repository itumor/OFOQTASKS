...
define("EW_RANDOM_KEY", 'oTA3iV7Q935ttHta', TRUE); // Random key for encryption
...
define("EW_CONN_DB", 'generator', TRUE);
...
define("EW_USER_PROFILE_SESSION_TIMEOUT", 9999, TRUE);
...
// Email
define("EW_SMTP_SERVER", "66.96.147.111", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 587, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "", TRUE);
define("EW_SMTP_SERVER_USERNAME", "itumor@unitedofoq.com", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "Abc@123456", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "itumor@unitedofoq.com", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "otmsadmin@unitedofoq.com", TRUE); // Recipient email address
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,sh,crt", TRUE); // Allowed file extensions
define("EW_IMAGE_ALLOWED_FILE_EXT", "gif,jpg,png,bmp", TRUE); // Allowed file extensions for images
define("EW_MAX_FILE_SIZE", 999999999, TRUE); // Max file size
