...
class cupdate_task extends cTable {
	...
	function __construct() {
		...
		// FILEPATH
		$this->FILEPATH = new cField('update_task', 'update_task', 'x_FILEPATH', 'FILEPATH', '`FILEPATH`', '`FILEPATH`', 200, -1, TRUE, '`FILEPATH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['FILEPATH'] = &$this->FILEPATH;

		// FILENAME
		$this->FILENAME = new cField('update_task', 'update_task', 'x_FILENAME', 'FILENAME', '`FILENAME`', '`FILENAME`', 200, -1, TRUE, '`FILENAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
